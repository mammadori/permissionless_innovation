...
\pgfdeclareimage[height=4cm]{wallet}{figures/fbk_wallet.pdf}
...
\section{How does Bitcoin works?}
...
\begin{frame}{Blockchain}{Decentralized Ledger}
...
\begin{frame}{The Technology}{Underliyng value}

\begin{exampleblock}{Eric Schmidt (Google's former CEO)}
